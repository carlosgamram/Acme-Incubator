...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			<acme:menu-suboption code="master.menu.anonymous.patonbulletin.list" action="/anonymous/patonbulletin/list"/>
			<acme:menu-suboption code="master.menu.anonymous.patonbulletin.form" action="/anonymous/patonbulletin/create"/>
			...
			<acme:menu-suboption code="master.menu.anonymous.miguel-favourite-link" action="https://cat-bounce.com/"/>
		</acme:menu-option>
